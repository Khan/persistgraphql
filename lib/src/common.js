...
exports.getQueryDocumentKey = exports.getQueryKey = exports.applyQueryTransformers = exports.applyFragmentDefinitionSort = exports.sortFragmentsByName = void 0;
...
function getQueryKey(definition, queryTransformers) {
    ...
    return (0, graphql_1.print)(applyQueryTransformers(wrappingDocument, queryTransformers).definitions[0]);
}
exports.getQueryKey = getQueryKey;
function getQueryDocumentKey(document, queryTransformers) {
    if (queryTransformers === void 0) { queryTransformers = []; }
    return (0, graphql_1.print)(applyFragmentDefinitionSort(applyQueryTransformers(document, queryTransformers)));
}
